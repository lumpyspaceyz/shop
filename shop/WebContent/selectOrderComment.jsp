...
<%
	...
	OrderComment orderComment = orderCommentDao.selectOrderComment(orderNo, ebookNo);
%>
<!DOCTYPE html>
<html>
<head>
	...
	<form method="post" action="<%=request.getContextPath() %>/insertOrderCommentAction.jsp?orderNo=<%=orderNo %>&ebookNo=<%=ebookNo %>">
		<div class="container p-3 my-3 border">
			...
			<table class="table table-borderless table-hover text-center">
				...
				<tbody>
					<tr class="font-weight-bold">
						<td><textarea rows="10" cols="135" name="orderCommentContent" readonly="readonly"><%=orderComment.getOrderCommentContent() %></textarea></td>
					</tr>
				</tbody>
			</table>
		</div>
