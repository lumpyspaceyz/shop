...
%>
					<tr>
						...
						<td><a href="<%=request.getContextPath() %>/updateQnaCommentForm.jsp?qnaNo=<%=qnaComment.getQnaNo() %>" class="btn btn-outline-light text-dark">수정</a></td>
						<td><a href="<%=request.getContextPath() %>/deleteQnaCommentAction.jsp?qnaNo=<%=qnaComment.getQnaNo() %>" class="btn btn-outline-light text-dark">삭제</a></td>
